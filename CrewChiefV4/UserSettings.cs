...
namespace CrewChiefV4
{
    class UserSettings
    {
        ...
        private String[] reservedNameStarts = new String[] { "CHANNEL_", "TOGGLE_", "VOICE_OPTION", "background_volume", 
            ...
            "update_notify_attempted", "last_trace_file_name", "READ_CORNER_NAMES_FOR_LAP", "GET_CAR_STATUS", "GET_SESSION_STATUS", "GET_DAMAGE_REPORT","GET_FRIEDN_DELTA", "GET_STATUS",
